...
export class AuthService {
    ...
    getAccessToken(param: FormGroup) // : Observable<any> {
    {
        ...
        // return this.http.post<Token>(`${this.env.apiUrl}/login`, param.value, { headers: headers })
        //     .pipe(
        //         map(tokens => {
        ...
        //       .pipe(
        //           map (tokens => {
        //               console.log('result from api :', tokens)
        //           }),
        //                   catchError(this.handleError)
        //                );
        this.http.post(`${this.env.apiUrl}api/login`, param.value, { headers: headers }).subscribe((data: any) => {
    ...
    register(resgisterForm: FormGroup) {
        return this.http.post(`${this.env.apiUrl}api/register`, resgisterForm.value)
    }
}